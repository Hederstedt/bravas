...
- [x] **Tvärspelsbetyg:** World of Tanks lägger till en bonus (max ~5 poäng, klampad vid 99) ovanpå CS2-betyget, aldrig ett avdrag — den som länkar ett svagt WoT-konto tappar inget. Har man bara länkat WoT (stängd CS2-profil) blir WoT-betyget basen i stället för ett tomt kort. Rollen (t.ex. "AWP" eller "KANON") är helt enkelt det starkaste attributet oavsett spel, lika avgörs till CS2:s fördel. Nya WoT-medvetna kommentarer, inklusive en för den som spelar båda spelen. Rubriken "BVS-BETYG" och en förklaringstext (hur betyg/roll/tier räknas) ersätter det obegripliga "65 ENTRY" ingen förstod.
